 ...
 * database access.
 */
public final class EventFeedQuery {
    ...
    public static EventFeedQuery parse(String query) {
        String source = null;
        ...
        return new EventFeedQuery(source, eventType, toolName, cwd, exactCwd, groupCwd,
