...
public final class RateLimitDetector {
    ...
    private static final Pattern LIMIT_EXHAUSTED =
            Pattern.compile("(?i)(?:\\b(?:rate|usage)\\s+limits?\\b[^\\n]{0,80}\\b(?:reached|exceeded|exhausted|hit)\\b"
    ...
    private static final Pattern STATUS_429 =
            Pattern.compile("(?i)(?:\\b(?:http|status|error|failed|failure)\\b.{0,40}\\b429\\b"
