...
public class RunContextLoader {
    ...
    public Optional<StageContext> loadSdlcContext(
            TaskChange claimedTask, RunnerConfig config, String actorId, String stageLabel) {
    ...
    public record StageContext(TaskSpec spec, RepoConfig repoConfig, File repoDir, String resolvedVerify) {}
}
