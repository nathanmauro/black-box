...
public class SummaryController {
    ...
    public SummaryController(SummaryOperations summaryService, SummaryExportOperations summaryExportService) {
    ...
    public AgentSession summarizeByClientSession(@RequestParam String source, @RequestParam String clientSessionId) {

        return summaryService.summarize(source, clientSessionId);
    }

    @PostMapping("/sessions/summarize-missing")
    public SummaryBackfillResult summarizeMissing(@RequestParam(defaultValue = "10") int limit) {
    ...
    public SummaryExport exportSummary(@PathVariable String sessionId, @PathVariable String targetId) {
