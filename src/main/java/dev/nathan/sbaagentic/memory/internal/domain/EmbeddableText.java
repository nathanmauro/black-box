...
public final class EmbeddableText {
    ...
    private static final Pattern HANDOFF_PREFIX =
            Pattern.compile("^Handoff to [^:]{1,120}:\\s*", Pattern.CASE_INSENSITIVE);
    ...
    private static String normalize(String text) {
        ...
        return collapsed
                .substring(0, collapsed.offsetByCodePoints(0, MAX_CODE_POINTS))
                .strip();
    }
