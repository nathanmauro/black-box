-- PostgreSQL canonical schema. Timestamp/JSON text preserves the existing wire and history format.
...
CREATE TABLE IF NOT EXISTS memory_embeddings (
    ...
    vector       BYTEA NOT NULL,          -- little-endian float32, dimensions * 4 bytes
