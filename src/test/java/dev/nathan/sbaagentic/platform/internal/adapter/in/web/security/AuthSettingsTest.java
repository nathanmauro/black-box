...
class AuthSettingsTest {
    ...
    void enabledAuthenticationFailsClosedWithoutBothIndependentStrongSecrets() {
        ...
        assertThatThrownBy(() -> new AuthSettings(environment)).isInstanceOf(IllegalStateException.class)
        ...
        assertThatThrownBy(() -> new AuthSettings(environment)).hasMessageContaining("different secrets")
                .hasMessageNotContaining(password);
