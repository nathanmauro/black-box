...
class CaptureIdentityTest {
    ...
    void digestV1KeepsItsFixedFieldAndSerializationContract() {
        var event = new EventIngestRequest(
                " Codex ",
                " client-42 ",
                null,
                "Observation",
                ...
                "/repo",
                "shell",
                Map.of("flags", List.of("a", "b"), "command", "printf hi"),
                null,
                Map.of("z", List.of(3, 2, 1), "a", Map.of("second", "two", "first", "one")),
                Instant.parse("2026-09-19T12:34:56.123456789Z"));
        var identity =
                CaptureIdentity.from(new IdempotentEventIngestRequest("5F067AD6-902F-4AE9-BC58-0FD1DE998C33", event));
        ...
        assertThat(identity.requestHash())
                .isEqualTo("2ecca5dc8e4429967204f30b72d20d048cd072524197628481662f2c6506f3bb");
