...
class GoalPromptBuilderTest {
    ...
    void buildsFrozenStoryThenVerbatimGuardrailsThenTaskSpecificCompletionProtocol() {
        ...
        assertThat(prompt.indexOf("# Frozen story")).isLessThan(prompt.indexOf("mvn test"));
        assertThat(prompt.indexOf("mvn test")).isLessThan(prompt.indexOf("## Guardrails"));
        assertThat(prompt.indexOf("## Guardrails")).isLessThan(prompt.indexOf("## Completion protocol"));
        assertThat(prompt)
                .contains(
    ...
    void buildsReadOnlyPlanPromptWithVerbatimGuardrailsAndPlanProtocol() {
        ...
        assertThat(prompt.indexOf("# Frozen story")).isLessThan(prompt.indexOf("## SDLC plan stage"));
        assertThat(prompt.indexOf("## SDLC plan stage")).isLessThan(prompt.indexOf("mvn test"));
        assertThat(prompt.indexOf("mvn test")).isLessThan(prompt.indexOf("## Guardrails"));
        assertThat(prompt.indexOf("## Guardrails")).isLessThan(prompt.indexOf("## Completion protocol"));
        assertThat(prompt)
                .contains(
    ...
    void buildsAdversarialReviewPromptWithApprovedPlanAndVerbatimGuardrails() {
        ...
        String prompt = new GoalPromptBuilder().buildReview(taskId, story, "mvn test", approvedPlan);

        assertThat(prompt.indexOf("# Frozen story")).isLessThan(prompt.indexOf("## Approved plan"));
        assertThat(prompt.indexOf(approvedPlan)).isLessThan(prompt.indexOf("## SDLC review stage"));
        assertThat(prompt.indexOf("## SDLC review stage")).isLessThan(prompt.indexOf("mvn test"));
        assertThat(prompt.indexOf("mvn test")).isLessThan(prompt.indexOf("## Guardrails"));
        assertThat(prompt.indexOf("## Guardrails")).isLessThan(prompt.indexOf("## Completion protocol"));
        assertThat(prompt)
                .contains(
