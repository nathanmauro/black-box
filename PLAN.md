...
- Demo GIF captured with `./scripts/record-demo.sh` lands at `docs/assets/demo.gif`.
...
- `docs/assets/demo.gif` — terminal demo GIF used by README, generated by `scripts/record-demo.sh`; the older still image remains at `docs/assets/hero.png`. Done.
